    ...
    <div>
        <section class="checkout">
            <router-link :to="{name:'address-list',query:$route.query}">
                ...
                <div class="header-del" @click="del">删除</div>
            </router-link>
        </section>
        <section class="addressfrom">
            <div class="username">
                ...
                <div class="input-group-wrap">
                    ...
                    <div class="input-wrap bottom">
                        <span :class="{radio:true,checked:data.gender==='先生'}" @click="setGender('先生')">先生</span>
            ...
            <div class="username">
                ...
                <div>
                    <div class="userphone">
                        <input type="text" placeholder="你的手机号" class="input-wrap" v-model="data.phone">
...
<script>
    export default{
        ...
        methods:{
            ...
            del:function () {
                fetch('/api/delete_address?id='+this.data.id)
                    .then(res=>res.json())
                    .then(data=>{
                        if(data==2){
                        }
        ...
        mounted(){
            fetch('/api/select_c_address?sid='+this.sid+'&id='+this.data.id)
                .then(res=>res.json())
                .then(data=>{
                    if(data.code==2){
                        this.data=data.data;
